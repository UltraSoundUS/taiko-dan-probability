...
const update_total_output = () => {
  ...
  // 確率を計算する。
  const prob_good = calc_prob_less_than(mean_good, var_good, document.getElementById("req-good").value);
  const prob_bad = calc_prob_less_than(mean_bad, var_bad, document.getElementById("req-bad").value);
